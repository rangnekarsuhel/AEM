...
public class NseStockV2 {
	...
	@PostConstruct
	protected void init() throws ClientProtocolException, IOException {

		/*
		 * String Symbol = "SBIN,ZELL"; String[] tokens = Symbol.split(","); for (int i
		 * = 0; i < tokens.length; i++) { logger.info("Debug NSE {} ", tokens[i]); }
		 */
		...
		try {
			...
			propertiesSymbol = propertiesSymbol + ".NS";
			get.setQueryString("symbols=" + propertiesSymbol);
